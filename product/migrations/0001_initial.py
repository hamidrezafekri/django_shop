    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('P', 'percent'), ('A', 'amount')], max_length=50, verbose_name='type of discount')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('T', 'toamn'), ('D', 'dollar')], max_length=50, verbose_name='unit of money')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favourite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.favourite', verbose_name='favourite product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_image', models.BooleanField(verbose_name='main image')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product', verbose_name='product image')),
            ],
            options={
                'abstract': False,
            },
